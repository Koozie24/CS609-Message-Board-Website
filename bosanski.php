...
<html>
<head>
    <title>Bosanski Razgovor</title>
</head>

<body>
    <div class='banner'>
        <h1>Dobrodosli u Balkan Klub</h1>
        <h3>Kad ljudi prica ovdje, sve jezik ce biti Bosanski. Forum na engleskom naci cete na pocetnoj stranici.</h3>
        <h3>Svaki tema na ovoj stranici je o janje i rakija. Bicete banovani ako objavite bilo sta drugo.</h3>
    </div>
    <?php
        include("config.php");
        session_start();
        ...
        //format query
        $sql = "SELECT User, ContentTitle, ContentText, Created, ContentID FROM content_table WHERE topic = 'Bosanski' ORDER BY ContentID DESC";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<h4><a href='reply.php?ContentID=". $row['ContentID'] . "&Topic=3 class='reply'>Reply</a></h4>";
                echo "</div>";
    ...
    ?>
    <div class='options'>
        <h4><a href="welcome.php" id="home">Kuca</a></h4>
        <h4><a href="create_post.php" id="post">Napravi Novu Objavu</a></h4>
        <h4><a href="logout.php" id="sign-out">Odjaviti Se</a></h4>
    </div>
</body>

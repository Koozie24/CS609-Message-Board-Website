...
<body>
    <div class='banner'>
        <h1>Welcome to the General Discussion Area</h1>
        <h3>Here you may post about any general topic... generally.</p>
    </div>
    <?php
        include("config.php");
        session_start();
        ...
        //format query
        $sql = "SELECT User, ContentTitle, ContentText, Created, ContentID FROM content_table WHERE topic = 'General' ORDER BY ContentID DESC";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<h4><a href='reply.php?ContentID=". $row['ContentID'] . "&Topic=2 class='reply'>Reply</a></h4>";
                echo "</div>";
